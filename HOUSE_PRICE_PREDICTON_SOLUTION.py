...
train = pd.read_csv("machine_learning/House_Prediction/train.csv")
train.head()
train.info()
test = pd.read_csv("machine_learning/House_Prediction/test.csv")
test.head()
test.info()
...
dfSubmission.to_csv("machine_learning/House_Prediction/housePricePredictions.csv", index=False)
